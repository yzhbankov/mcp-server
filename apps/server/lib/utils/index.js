...
function queryMySQL(config_1, sql_1) {
    return __awaiter(this, arguments, void 0, function (config, sql, params) {
        var connection, rows;
        if (params === void 0) { params = []; }
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, promise_1.default.createConnection(config)];
                case 1:
                    connection = _a.sent();
                    _a.label = 2;
                case 2:
...
function readFilesRecursively(dir) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fs_1.promises.readdir(dir, { withFileTypes: true })];
                case 1:
                    entries = _a.sent();
                    return [4 /*yield*/, Promise.all(entries.map(function (entry) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                ...
                                if (entry.isDirectory()) {
                                    return [2 /*return*/, readFilesRecursively(fullPath)];
                                }
                                else {
